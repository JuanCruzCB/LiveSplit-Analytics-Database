...
class QueryRunner:
    ...
    def _build_combined_data(
        ...
        *,
        ...
        """
        Returns a DataFrame that combines all the resulting DataFrames obtained by running all the
        specified queries, left to right.

        Optionally, it can add a "Best" column and a "Cumulative best" column at the end.
        """
        dfs = []
